...
public class ResponderDatabaseListAdapter extends ArrayAdapter<Responder> {

    private LayoutInflater inflater;

    public ResponderDatabaseListAdapter(Context context) {
        super(context, R.layout.fragment_demo_responder_database);
